...
export const transformationDescriptions = {
	...
	[TransformationType.DES]: 'DES Encrypt: encrypt data using Data Encryption Standard with configurable mode, padding, and IV',
	[TransformationType.AES]: 'AES Encrypt: encrypt data using Advanced Encryption Standard with configurable mode, padding, and IV',
	[TransformationType.DES_DECRYPT]: 'DES Decrypt: decrypt DES ciphertext using matching key, mode, padding, and IV',
	[TransformationType.AES_DECRYPT]: 'AES Decrypt: decrypt AES ciphertext using matching key, mode, padding, and IV',
